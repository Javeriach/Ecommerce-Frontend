...
function DashboardProductItem({ item, index }) {
  ...
  let { deleteProductHandler ,showOverlay, setShowOverlay,UpdateProductHandler} = useEShopData();
  ...
  let updatedProduct = ()=>
  {
    ...
    return (
            ...
            <tr className={`${Style.productColumn}`}>
                    <td className="border border-1 text-center"><p className={Style.width4}>{index + 1}</p></td>
        <td className={` border border-1 p-3`}>
          ...
          <img
                    ...
                    <td
                      className={`text-center border border-1 text-center`}
                  >
                     <label htmlFor="" className={`${Style.description} text-justify ${Style.width1}`}>
                     {item.description}
                      </label>
                    ...
                    <div className={`d-flex justify-content-center ${Style.width3}`}>
                      ...
                      {!isLoading ? (
                        ...
                        />
                         ...
                         <div className='ms-2'> <Spinner /> </div>
                      )}
