...
export default function Login() {
  ...
  return (
    <div className="w-full  h-screen  shadow-2xl flex  justify-center  pt-[60px] overflow-y-auto ">
      <div className="card text-black w-[320px]  mt-[60px] h-fit max-w-96 shadow-xl">
        <div className="card-body ">
            ...
            <>
              ...
              <label className="input input-bordered flex items-center gap-2 w-full">
                <svg
                  ...
                  viewBox="0 0 16 16"
                  fill="currentColor"
                  className="h-4 w-4 opacity-100 text-black focus:border-none"
                >
                  <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM12.735 14c.618 0 1.093-.561.872-1.139a6.002 6.002 0 0 0-11.215 0c-.22.578.254 1.139.872 1.139h9.47Z" />
                </svg>
                <input
                  type="text"
                  className="w-[200px] text-black border-0 onfocus:border-none group-focus-visible:border-none active:outline-none"
          ...
          <div>
            <label className="input input-bordered flex items-center gap-2 text-black -full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 16 16"
                fill="currentColor"
            ...
            {loginFrom && !forgetPassword && (
              <div>
                <p
                  className="ms-[125px] text-[15px] mt-2 font-semibold cursor-pointer"
                  onClick={() => {
